 ...
 */
package lyzzcw.work.speedkill.gateway.config;
 ...
 */
@Configuration
@ComponentScan(value = {"lyzzcw.work.speedkill.gateway"})
@ServletComponentScan(basePackages = {"lyzzcw.work.speedkill.gateway"})
...
//        this.initCustomizedApis();
    ...
    private void initGatewayRules() {
         ...
         **/
        //用户微服务-设置为自定义限流器
//        rules.add(this.getGatewayFlowRule(getResource("user")));
        //秒杀活动微服务
        rules.add(this.getGatewayFlowRule(getResource("activity")));
        //秒杀商品微服务
        rules.add(this.getGatewayFlowRule(getResource("goods")));
        //秒杀订单微服务
        rules.add(this.getGatewayFlowRule(getResource("order")));
        //加载规则
